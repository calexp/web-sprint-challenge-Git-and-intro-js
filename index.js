...
function addArtist(array) {
  const newArray = []; 
  newArray.push(id: 20, name: Alex, years: 1998-2022, genre: web design, nationality: american, bio: Im 23 years old and learning how to code!)
}
console.log(addArtist(newArray);
...
function artistByCountry(artists, Spanish){
  if(artists(nationality) === Spanish){
    return artists
  }
}
